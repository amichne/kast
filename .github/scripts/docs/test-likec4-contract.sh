...
require_contains docs/architecture/views.c4 'view headless-semantic-pipeline'
require_contains docs/architecture/views.c4 'view retained-evidence'
require_contains docs/architecture/deployment.c4 'deployment view headless-runtime'
require_contains docs/architecture/deployment.c4 'foreground IDE has no lifecycle or routing edge'
