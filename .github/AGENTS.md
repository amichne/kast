...
owns the repository-shape, release-flow, and public-installer gates. The Kotlin
job owns architecture verification and the Gradle test graph. PR #633 reuses
that Kotlin job for GATE-060. The
