...
- `tasks/receipt/` owns typed post-authority progression. KVP-002 through KVP-010 and KVP-012
  through KVP-015 execute their exact included-build gates without shell parsing, emit generated
  ...
  KVP-014 and binds the supported-build epoch-signal ledger.
