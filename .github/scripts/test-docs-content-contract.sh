...
require_not_contains "$docs_root" "kast setup" "Docs must not document the retired broad setup command"
require_not_contains "$docs_root" "kast install affected" "Docs must not document the retired broad affected repair command"
