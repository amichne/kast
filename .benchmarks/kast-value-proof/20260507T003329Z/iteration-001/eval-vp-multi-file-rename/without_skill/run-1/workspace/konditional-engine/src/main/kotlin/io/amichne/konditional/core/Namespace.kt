...
import io.amichne.konditional.core.registry.FeatureRegistry
...
open class Namespace private constructor(
    ...
    val registry: FeatureRegistry = InMemoryNamespaceRegistry(namespaceId = id.value),
    @PublishedApi internal val identifierSeed: NamespaceId.Seed = id.seed(),
) : FeatureRegistry by registry {
    ...
    abstract class TestNamespaceFacade(
        id: String,
        registry: FeatureRegistry = InMemoryNamespaceRegistry(namespaceId = id),
