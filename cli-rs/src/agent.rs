...
use crate::cli::{
    ...
    AgentRenameArgs, AgentReplaceDeclarationArgs, AgentRepositoryArgs, AgentRepositoryField,
    AgentRepositoryIntent, AgentRepositoryViewArgs, AgentReusableSymbolSelector,
