...
require_text "--gradle-jvmargs \"\${{ inputs.gradle_jvmargs }}\""
require_text "--kotlin-daemon-jvmargs \"\${{ inputs.kotlin_daemon_jvmargs }}\""
require_text "--gradle-workers-max \"\${{ inputs.max_concurrent_requests }}\""
require_text "--docker-memory \"\${{ inputs.docker_memory }}\""
