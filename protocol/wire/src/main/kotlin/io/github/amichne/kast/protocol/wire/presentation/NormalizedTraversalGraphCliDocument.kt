...
@Serializable @JvmInline value class TraversalGraphNodeIndex(val value: Int)

@Serializable @JvmInline value class TraversalGraphProofIndex(val value: Int)

@Serializable
data class NormalizedTraversalGraphCliDocument(
...
data class TraversalGraphSnapshotCliDocument
private constructor(
...
@Serializable
data class NormalizedTraversalNodeCliDocument(
...
@Serializable
data class NormalizedTraversalEdgeCliDocument(
    val depth: Int,
    val meaning: String,
...
@Serializable
data class NormalizedTraversalOccurrenceCliDocument(
...
@Serializable
data class NormalizedTraversalProofCliDocument(
