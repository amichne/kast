...
@JvmInline
value class TopologyCoverageSourceHash private constructor(val value: String) {
    companion object {
        /**
         * Proof transition: `String -> Refinement<TopologyCoverageSourceHash, TopologyCoverageSourceHashFailure>`.
         *
         * Establishes the exact 64-character lowercase SHA-256 form used by topology source evidence.
         * [TopologyCoverageSourceHashFailure] is the closed expected failure. Raw hash text may enter only from
         * topology composition or the generated wire boundary.
         */
        fun parse(raw: String): Refinement<TopologyCoverageSourceHash, TopologyCoverageSourceHashFailure> =
...
private constructor(
    ...
    companion object {
        /**
         * Proof transition: exact topology endpoint fields to a compiler-grounded public symbol. The node identity,
         * source file, kind, and qualified identity must all agree with the retained canonical compiler signature.
         * Expected disagreement is finite data.
         */
        fun create(
            ...
            if (node.compilerIdentity != compilerEvidence.identity) {
                return Refinement.Rejected(TopologyCoverageSymbolFailure.NODE_COMPILER_IDENTITY_MISMATCH)
            }
...
private fun TopologyCoverageSymbolKind.symbolKind(): SymbolKindDocument =
    when (this) {
...
@ConsistentCopyVisibility
data class TopologyCoverageFailure
private constructor(
    ...
    companion object {
         ...
         *
         * Establishes a non-empty coverage failure and detaches every retained mismatch into immutable sets.
         * [TopologyCoverageFailureAdmissionFailure] is the closed expected failure. Typed values may be extracted only
         * by the generated wire serializer and CLI presentation boundaries.
         */
        fun admit(
