...
| Kast contributor | `docs/distribute/local-development-refresh.md` | Activate one processless machine bundle from a checkout | `docs/reference/runtime-and-output.md` |
...
| `docs/distribute/local-development-refresh.md` | How-to guide | Refresh and verify one processless development-machine authority | Keep reconciliation closed-IDE and synchronous |
