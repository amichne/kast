...
class HostedClientTest(unittest.TestCase):
    ...
    def reply(self, raw, request=None):
        ...
        metadata = dict(type="KAST_IDE_ENDPOINT", protocol=3, host="00000000-0000-0000-0000-000000000001", querySchema="kast.query.run.v2", root=str(self.root), socket=str(path), hostPid=123,
                        operations=["DESCRIBE", "CLASS_LOOKUP", "DIRECT_SUPERTYPE", "QUERY_RUN", "SYMBOL_DISCOVER", "SYMBOL_INSPECT", "SOURCE_READ", "TRAVERSAL_RUN", "DIAGNOSTIC_CHECK", "CHANGE_PLAN", "CHANGE_APPROVAL_PREPARE", "CHANGE_APPLY", "CHANGE_RECOVER"])
    ...
    def test_host_identity_must_match_descriptor(self):
        result = dict(type="KAST_IDE_HOST", protocol=3, host="00000000-0000-0000-0000-000000000001", querySchema="kast.query.run.v2", root=str(self.root), hostPid=124,
                      operations=["DESCRIBE", "CLASS_LOOKUP", "DIRECT_SUPERTYPE", "QUERY_RUN", "SYMBOL_DISCOVER", "SYMBOL_INSPECT", "SOURCE_READ", "TRAVERSAL_RUN", "DIAGNOSTIC_CHECK", "CHANGE_PLAN", "CHANGE_APPROVAL_PREPARE", "CHANGE_APPLY", "CHANGE_RECOVER"], indexAuthority="existing_ide_kotlin_stub_index")
