...
require_block_contains "$ci_workflow" "  prepared-ubuntu-debian-bundle:" "  prepared-kast-action-runtime:" "      - prepared-generation" "Ubuntu and Debian package derivation must consume the immutable prepared generation"
require_block_contains "$ci_workflow" "  prepared-ubuntu-debian-bundle:" "  prepared-kast-action-runtime:" "--kind ubuntu-debian-bundle" "Ubuntu and Debian packaging must select only its own derivative"
require_block_contains "$ci_workflow" "  prepared-ubuntu-debian-bundle:" "  prepared-kast-action-runtime:" "dist/kast-ubuntu-debian-headless-x86_64-v0.7.11-ci.tar.gz.sha256" "The derived Ubuntu and Debian bundle upload must preserve its required digest sidecar"
require_block_contains "$ci_workflow" "  prepared-kast-action-runtime:" "  install-ubuntu-debian-container:" "      - prepared-generation" "kast-action package derivation must independently consume the immutable prepared generation"
require_block_contains "$ci_workflow" "  prepared-kast-action-runtime:" "  install-ubuntu-debian-container:" "--kind kast-action-runtime" "kast-action packaging must select only its own derivative"
...
require_block_contains "$ci_workflow" "  kast-action-runtime-contract:" "  installed-semantic-fixture:" "      - prepared-kast-action-runtime" "kast-action validation must consume the focused action-runtime producer"
