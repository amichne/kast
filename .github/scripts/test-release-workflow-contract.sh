...
require_not_contains "$release_workflow" "scripts/package-ubuntu-debian-bundle.sh" "Default release must not use the shell compatibility wrapper for Linux headless packaging"
