...
internal suspend fun KastIndexerBackend.diagnosticsOperation(query: ParsedDiagnosticsQuery): DiagnosticsResult = withContext(readDispatcher) {
...
internal fun KastIndexerBackend.diagnosticNextOffset(
        snapshot: DiagnosticSnapshot,
        pageOffset: Int,
        maxResults: Int,
    ): Int {
...
internal fun KastIndexerBackend.analyzeDiagnosticsFileInReadEpoch(filePath: NormalizedPath): DiagnosticsFileAnalysis {
...
internal fun KastIndexerBackend.skippedDiagnostics(
    ...
    // ReferencesSearch resolves import directives as reference sites, so this
    // indexer does not need separate import-FQN handling.
