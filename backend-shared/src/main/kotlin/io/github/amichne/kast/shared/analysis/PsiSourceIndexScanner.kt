...
data class PsiSourceIndexScanResult(
...
class PsiSourceIndexScanner internal constructor(
    ...
    fun scanFile(filePath: String): PsiSourceIndexScanResult? = environment.withReadAccess {
        ...
        PsiSourceIndexScanResult(
            contentHash = FileContentHash.parse(FileHashing.sha256(content)),
            update = parsed.copy(packageEvidence = packageEvidence),
        )
    }
