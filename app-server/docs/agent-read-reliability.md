...
| [v0.40.13](https://github.com/amichne/kast/releases/tag/v0.40.13) | `47f890313156819d5a5d1becd9457a09787b104e` | Original installed coordinator lifecycle qualification fixture | [Exact-head CI](https://github.com/amichne/kast/actions/runs/34906530555); [release build](https://github.com/amichne/kast/actions/runs/34906991292). All assets/checksums, executable/catalog and installer dry-run verified. The fixture requires real initialize/thread/start, clean detach, prepared owned service and successful disable. |
