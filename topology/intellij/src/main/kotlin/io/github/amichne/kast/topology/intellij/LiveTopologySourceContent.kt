...
internal class LiveTopologySourceContent private constructor(val file: TopologySourceFile) {
    companion object {
        /**
         * Proof transition: `(TopologySourceFile, ByteArray) -> Refinement<LiveTopologySourceContent,
         * TopologySourceContentFailure>`.
         *
         * Establishes that live VFS bytes have the exact SHA-256 identity carried by the admitted topology file.
         * [TopologySourceContentFailure] is the closed expected failure. Raw bytes may enter only while loading one VFS
         * file inside the IntelliJ extraction adapter.
         */
        fun validate(
