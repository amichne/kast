...
internal suspend fun KastIndexerBackend.resolveSymbolOperation(query: ParsedSymbolQuery): SymbolResult = withContext(readDispatcher) {
...
internal suspend fun KastIndexerBackend.findReferencesOperation(query: ParsedReferencesQuery): ReferencesResult = withContext(readDispatcher) {
...
internal fun KastIndexerBackend.referenceContinuationPage(
...
internal suspend fun KastIndexerBackend.referenceSearchPlan(
        query: ParsedReferencesQuery,
        span: IdeaTelemetrySpan,
    ): ReferenceSearchPlan {
...
internal fun KastIndexerBackend.indexedReferenceSearch(
        query: ParsedReferencesQuery,
