...
@TestApplication
internal class KastIndexerBackendContractTestPersistedSearchScope : KastIndexerBackendContractTestFixture() {
    @Test
    ...
    private suspend fun withPersistedScope(
        block: suspend (PersistedSearchScopeInputs, KastIndexerBackend) -> Unit,
    ) {
