...
| **Exact product** | CLI version, private-extension version, IDE build, Kotlin plugin build, registry digest, wire digest, protocol identity, and capabilities agree. |
