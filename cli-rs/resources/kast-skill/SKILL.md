...
3. Preserve typed identities and blockers returned by Kast while doing
...
action exactly. Do not suppress diagnostics, substitute an unobserved Gradle
command, or claim success outside the lifecycle.
