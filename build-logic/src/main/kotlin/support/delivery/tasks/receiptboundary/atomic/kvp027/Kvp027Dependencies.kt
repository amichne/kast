 ...
 * exact report output digest. The admitted KVP-026 observed head becomes the implementation
 * baseline. Expected read, identity, closure, digest, or output mismatch remains finite
