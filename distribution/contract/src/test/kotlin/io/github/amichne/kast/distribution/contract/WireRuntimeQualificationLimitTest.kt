...
class WireRuntimeQualificationLimitTest {
    @Test fun `qualification rejects an encoded document above its byte limit`() {
        val attempt = (SemanticRuntimeBootstrapAttemptId.admit("00000000-0000-4000-8000-000000000001") as Refinement.Refined).value
        val identity = (WireRuntimeIdentity.admit(Path.of("/" + "é".repeat(9_000)), "sha256:" + "a".repeat(64), attempt) as Refinement.Refined).value
