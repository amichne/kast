...
enum class IntellijReadCounter {
    ...
    RELATION_K2_CONFIRMED_TARGETS,
    RELATION_K2_DIFFERENT_TARGETS,
    RELATION_K2_UNAVAILABLE_TARGETS,
    RELATION_CALL_OWNERS_FOUND,
