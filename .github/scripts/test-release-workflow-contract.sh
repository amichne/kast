...
require_not_contains "$ci_workflow" "developer codex generate" "CI must not generate the separately published Codex marketplace"
require_not_contains "$ci_workflow" "kast-codex-plugin" "CI must not package the separately published Codex marketplace"
...
require_not_contains "$release_workflow" "build-codex-plugin" "Kast releases must not build the separately published Codex marketplace"
require_not_contains "$release_workflow" "kast-codex-plugin" "Kast releases must not publish Codex marketplace assets"
...
require_not_contains "$release_provenance_assembler" '"codex-plugin"' "Kast provenance must not include the separately published Codex marketplace"
...
require_not_contains "$release_asset_verifier" 'kast-codex-plugin' "Release verifier must not require the separately published Codex marketplace"
