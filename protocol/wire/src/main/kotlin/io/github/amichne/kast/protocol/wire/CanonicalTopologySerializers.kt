...
/**
 * Proof transition: `TopologyCoverageCandidateEvidenceMismatchDocument -> TopologyCoverageCandidateEvidenceMismatch`.
 *
 * Establishes exact candidate and completed file evidence. [WireDocumentConversion.Rejected] is the closed expected
 * failure. Raw document fields remain inside the generated wire boundary.
 */
internal fun TopologyCoverageCandidateEvidenceMismatchDocument.toContract():
    WireDocumentConversion<TopologyCoverageCandidateEvidenceMismatch> =
    combineConverted(
 ...
 *
 * Establishes exact workspace, source-root, path, and SHA-256 evidence. [WireDocumentConversion.Rejected] is the closed
 * expected failure. Raw document fields remain inside the generated wire boundary.
 */
internal fun TopologyCoverageFileEvidenceDocument.toContract(): WireDocumentConversion<TopologyCoverageFileEvidence> =
    combineConverted(
...
/**
 * Proof transition: `TopologyCoverageWorkspaceEvidenceDocument -> TopologyCoverageWorkspaceEvidence`.
 *
 * Establishes refined root, generation, and source-state evidence. [WireDocumentConversion.Rejected] is the closed
 * expected failure. Raw document fields remain at this generated wire boundary.
 */
private fun TopologyCoverageWorkspaceEvidenceDocument.toContract():
    WireDocumentConversion<TopologyCoverageWorkspaceEvidence> =
    combineConverted(
...
/**
 * Proof transition: `TopologyCoverageSourceRootEvidenceDocument -> TopologyCoverageSourceRootEvidence`.
 *
 * Establishes refined imported-root identities and closed provenance. [WireDocumentConversion.Rejected] is the closed
 * expected failure. Raw document fields remain at this generated wire boundary.
 */
private fun TopologyCoverageSourceRootEvidenceDocument.toContract():
    WireDocumentConversion<TopologyCoverageSourceRootEvidence> =
    combineConverted(
...
private fun TopologyCoverageSourceRootProvenance.toSerializableDocument() =
    when (this) {
        TopologyCoverageSourceRootProvenance.AUTHORED -> TopologyCoverageSourceRootProvenanceDocument.AUTHORED
        TopologyCoverageSourceRootProvenance.GENERATED -> TopologyCoverageSourceRootProvenanceDocument.GENERATED
...
private fun TopologyCoverageSourceRootProvenanceDocument.toContract() =
    when (this) {
        TopologyCoverageSourceRootProvenanceDocument.AUTHORED -> TopologyCoverageSourceRootProvenance.AUTHORED
        TopologyCoverageSourceRootProvenanceDocument.GENERATED -> TopologyCoverageSourceRootProvenance.GENERATED
        TopologyCoverageSourceRootProvenanceDocument.UNKNOWN_EXCLUDED_FROM_SOURCE_MODEL ->
            TopologyCoverageSourceRootProvenance.UNKNOWN_EXCLUDED_FROM_SOURCE_MODEL
    }

internal fun TopologyCoverageProjectionRejection.toDocument() =
    when (this) {
        ...
        TopologyCoverageProjectionRejection.EMPTY_FAILURE -> TopologyCoverageProjectionFailureDocument.EMPTY_FAILURE
    }

internal fun TopologyCoverageProjectionFailureDocument.toContract() =
    when (this) {
        TopologyCoverageProjectionFailureDocument.UNREPRESENTABLE_TEXT ->
            TopologyCoverageProjectionRejection.UNREPRESENTABLE_TEXT
        TopologyCoverageProjectionFailureDocument.UNREPRESENTABLE_RANGE ->
        ...
        TopologyCoverageProjectionFailureDocument.UNREPRESENTABLE_COMPILER_EVIDENCE ->
            TopologyCoverageProjectionRejection.UNREPRESENTABLE_COMPILER_EVIDENCE
        TopologyCoverageProjectionFailureDocument.EMPTY_FAILURE -> TopologyCoverageProjectionRejection.EMPTY_FAILURE
    }
...
private fun TopologyCoverageSourceRootProvenanceDocument.sortRank(): Int =
    when (this) {
