...
data class SymbolQuery(
    ...
    @DocField(
        description = "When true, populates the declarationScope field on the resolved symbol.",
        defaultValue = "false"
    )
    val includeDeclarationScope: Boolean = false,
    @DocField(
        description = "When true, populates the documentation field on the resolved symbol.",
        defaultValue = "false"
    )
