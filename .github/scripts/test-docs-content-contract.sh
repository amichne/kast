...
require_contains "$readme" "scripts/install-ubuntu-debian.sh install" "README must document the Ubuntu/Debian compatibility entrypoint"
...
require_contains "$install_doc" 'scripts/install-ubuntu-debian.sh' "Install docs must document the Ubuntu/Debian compatibility entrypoint"
