...
/**
 * Per-operation editorial metadata used by [AnalysisDocsDocument] to enrich
 ...
 * [AnalysisOpenApiDocument.writePaths].
 */
data class OperationDoc(
    // Structural metadata (mirrors AnalysisOpenApiDocument.writePaths)
