...
internal object CliBoundaryDocuments {
    ...
    fun statusCompleteWithoutCache(
        ...
        statusWithoutCacheFactory.create(
    ...
    fun runtimeRejected(failure: RuntimeAdmissionFailure): CliJsonDocument =
        when (failure) {
            is RuntimeAdmissionFailure.IntellijBootstrap ->
                bootstrapRejectionFactory.create(
            ...
            is RuntimeAdmissionFailure.CacheQuarantineRejected ->
                quarantineRejectionFactory.create(
...
@Serializable private data class CliAbsentCacheDocument(val state: String)
...
private fun RuntimeEndpointArtifact.lifecycleOutputName(): String =
    when (this) {
        is RuntimeEndpointMarker -> name.lowercase()
        RuntimePersistentState -> "state"
    }

private val lifecycleFactory = CliJsonDocument.generated(CliLifecycleCompleteDocument.serializer())
private val brokerStoppedFactory = CliJsonDocument.generated(CliBrokerStoppedDocument.serializer())
private val statusWithoutCacheFactory = CliJsonDocument.generated(CliStatusWithoutCacheDocument.serializer())
private val statusWithCacheFactory = CliJsonDocument.generated(CliStatusWithCacheDocument.serializer())
private val boundaryFactory = CliJsonDocument.generated(CliBoundaryRejectedDocument.serializer())
private val usageFactory = CliJsonDocument.generated(CliUsageRejectedDocument.serializer())
...
private fun RuntimeBootstrapObservation.document(): CliBootstrapDocument =
    when (this) {
...
private fun SemanticRuntimeBootstrapState.document(): CliBootstrapDocument =
    when (this) {
        is SemanticRuntimeBootstrapState.Starting ->
            CliBootstrapDocument.Starting(
                attemptId.value,
                phase.wireName,
...
private val quarantineRejectionFactory = CliJsonDocument.generated(CliQuarantineRejectedDocument.serializer())
