...
internal suspend fun StandaloneAnalysisBackend.semanticInsertionPoint(query: SemanticInsertionQuery) =
...
internal suspend fun StandaloneAnalysisBackend.optimizeImports(query: ImportOptimizeQuery) =
    optimizeImports(query.parsed())
...
internal suspend fun StandaloneAnalysisBackend.workspaceSymbolSearch(query: WorkspaceSymbolQuery) =
    workspaceSymbolSearch(query.parsed())

internal suspend fun StandaloneAnalysisBackend.workspaceSearch(query: WorkspaceSearchQuery) =
    workspaceSearch(query.parsed())

internal suspend fun StandaloneAnalysisBackend.workspaceFiles(query: WorkspaceFilesQuery) =
    workspaceFiles(query.parsed())

internal suspend fun StandaloneAnalysisBackend.implementations(query: ImplementationsQuery) =
    implementations(query.parsed())
