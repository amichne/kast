...
fun interface QueryOperations {
     ...
     *
     * Successful results retain item exactness independently from aggregate coverage. Expected refinement and expansion
     * failures remain finite data rather than silently disappearing.
     */
