...
private fun SourceReadRejection.toWireDocument(): SourceReadRejectionWireDocument =
    when (this) {
...
private fun SourceReadRejectionWireDocument.toContract(): SourceReadRejection =
    when (this) {
