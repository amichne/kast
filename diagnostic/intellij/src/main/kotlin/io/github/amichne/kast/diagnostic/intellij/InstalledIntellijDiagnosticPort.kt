...
/**
 * Proof transition: `(CanonicalSemanticProjectRoot, WorkspaceInspectionOperations) -> DiagnosticCompilerPort`.
 *
 * Establishes one request-local K2 diagnostic port for the exact installed root. Missing projects and unavailable
 * current publications remain [DiagnosticCompilerRejection] data. Live project, VFS, PSI, and K2 values are obtained
 * and consumed only inside each compiler call.
 */
...
private fun unavailable(): DiagnosticCompilation =
