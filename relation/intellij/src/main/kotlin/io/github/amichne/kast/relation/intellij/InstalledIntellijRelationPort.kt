...
/**
 * Proof transition: `(CanonicalSemanticProjectRoot, WorkspaceInspectionOperations, InstalledRelationScopeOperations) ->
 * RelationCompilerPort`.
 *
 * Establishes one request-local K2 relation port for the exact installed root. Missing projects, unavailable
 * publications, and moved generations remain [RelationCompilerRejection] data. Live project, PSI, scope, native search,
 * and K2 values are obtained and consumed within each call.
 */
...
private fun unavailable(): RelationCompilation =
