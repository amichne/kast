...
private fun AnalysisTransport.displayName(): String = when (this) {
...
private fun KastActivitySeverity.toNotificationType(): NotificationType = when (this) {
...
private fun Throwable.compactMessage(): String = message?.takeIf(String::isNotBlank) ?: javaClass.simpleName
