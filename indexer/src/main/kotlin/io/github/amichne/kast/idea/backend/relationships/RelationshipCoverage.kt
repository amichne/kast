...
internal fun KastIndexerBackend.flattenCallRelations(
...
internal fun KastIndexerBackend.flattenHierarchyRelations(
...
internal fun KastIndexerBackend.relationshipEvidence(
...
internal fun KastIndexerBackend.limitedReferenceEvidence(
        knownMinimumCount: Int,
...
internal fun KastIndexerBackend.completeRelationshipCoverageAdmission(
...
internal fun KastIndexerBackend.limitedRelationshipCoverageAdmission(
...
internal fun KastIndexerBackend.continuationConflict(reason: String): ConflictException = ConflictException(
