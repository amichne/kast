...
require_order "$ci_workflow" "Free disk for kast-action runtime installation" "Package kast-action runtime inputs" "CI must establish the runtime installation disk budget before packaging"
