...
This source is a corpus index note.
...
- The original Kast note set was organized as a flat collection of linked notes.
- The README served as the pre-wiki navigation page for the corpus.
- The raw source layer already had meaningful topical coverage before synthesis.

## Connections

This source now plays a narrower but still useful role.

- Reinforces [[overview]]
- Adds context to [[index]]
- Complements [[sources/kast-overview]] as an orientation source
...
The pages below now acknowledge this source.
