        ...
        fun drain(capacity: Int, terminal: Boolean): Pair<List<String>, List<Pair<String, Long>>> {
                    ...
                    val batch =
                        io.github.amichne.kast.relation.contract.RelationBatch.create(
                                ...
                                io.github.amichne.kast.relation.contract.RelationByteCount.parse(
                                    ...
                                    .refined(),
                                io.github.amichne.kast.relation.contract.RelationWorkCount.parse(page.size.toLong())
                                    .refined(),
                        ...
                        val compilation =
                            io.github.amichne.kast.relation.contract.RelationCompilation.qualifiedResumable(
                                    ...
                                    page.fold(request.providerCursor) { cursor, fact ->
                                        cursor.advance(
                                            io.github.amichne.kast.relation.contract.RelationProviderItemDescriptor
                                                .parse(fact.canonicalProjection())
                                                .refined()
                                        )
                                    },
                                )
            ...
            repeat(12) {
                ...
                if (continuation is TraversalQualification.Resumable) {
                    plan =
                        TraversalPlan.resume(a, RelationMeaning.Callees, plan.budget, continuation.continuation)
                            .refined()
                } else {
