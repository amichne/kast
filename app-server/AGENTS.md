...
- [InstalledDaemonUpgrade.kt](src/main/kotlin/io/github/amichne/kast/appserver/InstalledDaemonUpgrade.kt) - installer-facing service presence proof and exact sealed update permit.
