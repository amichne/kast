...
require_not_contains "$install_doc" '.github/instructions/kast-kotlin.instructions.md' "Install docs must not document retired static Copilot instruction output"
