...
internal fun readinessDocument(readiness: ProbeSetupObservation): JsonElement =
    readinessJson.encodeToJsonElement(
        ...
        ProbeSetupReadinessDocument(
            ...
            dirtyMarkScope = readiness.drain.dirtyMark.scope,
            dirtyMark = readiness.drain.dirtyMark.outcome,
            pushedPropertiesDrain = readiness.drain.nativeTasks,
...
private data class ProbeSetupReadinessDocument(
    ...
    val dirtyMarkScope: ProbeDirtyMarkScope,
    val dirtyMark: ProbeDirtyMarkOutcome,
