...
data class DischargedChangeObligation
...
class DischargedChangeObligations private constructor(proofs: List<DischargedChangeObligation>) {
    ...
    companion object {
         ...
         *
         * Reifies every variant-specific obligation against its already accepted G0-to-G1 proof basis. There is no
         * expected failure because [CompleteChangeVerification] establishes an exhaustive obligation set. Only the
         * receipt boundary may expose these detached proofs.
         */
        internal fun issue(verification: CompleteChangeVerification): DischargedChangeObligations =
            DischargedChangeObligations(
...
private fun ChangeVerificationObligation.proofBasis(): ChangeObligationProofBasis =
    when (this) {
        ...
        ReplaceDeclarationObligation.DECLARED_WRITE_SET_CLOSED -> ChangeObligationProofBasis.APPLIED_MUTATION
        ...
        ReplaceDeclarationObligation.UNRELATED_CODE_PRESERVED -> ChangeObligationProofBasis.RESULT_SOURCE
        AddDeclarationObligation.OUTBOUND_BINDINGS_PRESERVED,
        AddDeclarationObligation.EXISTING_BINDINGS_PRESERVED,
        RenameSymbolObligation.REFERENCES_RETARGETED -> ChangeObligationProofBasis.RESULT_RELATIONS
        ...
        ReplaceDeclarationObligation.COMPILER_DIAGNOSTICS_CLEAR -> ChangeObligationProofBasis.RESULT_DIAGNOSTICS
        ...
        ReplaceDeclarationObligation.REPLACEMENT_DECLARATION_OBSERVED -> ChangeObligationProofBasis.RESULT_DECLARATION
        ...
        ReplaceDeclarationObligation.RESULT_GENERATION_PUBLISHED -> ChangeObligationProofBasis.RESULT_PUBLICATION
    }
