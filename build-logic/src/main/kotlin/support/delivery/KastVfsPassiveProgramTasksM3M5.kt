...
internal fun deliveryTasksM3M5(): List<TaskNode> = listOf(
            ...
            TaskNode(
                ...
                dependencies = DependencyExpression(EdgeKind.REQUIRES_ALL, setOf(TaskId("KVP-009"), TaskId("KVP-023"), TaskId("KVP-027"), TaskId("KVP-031"))),
                ...
                inputs = listOf(mapOf("id" to "CURRENT_HEAD", "kind" to "baseline"), mapOf("id" to "DELIVERY_AUTHORITY", "kind" to "programAuthority"), mapOf("id" to "kvp.009.proof", "kind" to "taskOutput"), mapOf("id" to "kvp.023.proof", "kind" to "taskOutput"), mapOf("id" to "kvp.027.proof", "kind" to "taskOutput"), mapOf("id" to "kvp.031.proof", "kind" to "taskOutput"), mapOf("id" to "KVP-REQ-006", "kind" to "requirement"), mapOf("id" to "KVP-REQ-011", "kind" to "requirement"), mapOf("id" to "KVP-REQ-014", "kind" to "requirement"), mapOf("id" to "KVP-REQ-016", "kind" to "requirement"), mapOf("id" to "KVP-REQ-027", "kind" to "requirement")),
            ...
            TaskNode(
                ...
                allowedReads = listOf("gradle/delivery/kast-vfs-passive-requirements.json", "gradle/delivery/receipts", "build/reports/ide-hosted", "/mnt/data/pasted.txt"), allowedWrites = listOf("build/reports/ide-hosted/specification-revalidation.json", "docs/plans/kast-vfs-passive-revalidation.md"),
