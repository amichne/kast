...
private fun IndexSyncStateDocument.toWire(): IndexSyncStateWireDocument =
    when (this) {
...
private fun IndexSyncStateWireDocument.toContract(): IndexSyncStateDocument =
    when (this) {
...
private fun IndexSyncQualification.toWire(): IndexSyncQualificationWireDocument =
    when (this) {
        IndexSyncQualification.INDEXING_IN_PROGRESS -> IndexSyncQualificationWireDocument.INDEXING_IN_PROGRESS
    }

private fun IndexSyncQualificationWireDocument.toContract(): IndexSyncQualification =
    when (this) {
        IndexSyncQualificationWireDocument.INDEXING_IN_PROGRESS -> IndexSyncQualification.INDEXING_IN_PROGRESS
    }

private fun IndexSyncRejection.toWire(): IndexSyncRejectionWireDocument =
    when (this) {
        IndexSyncRejection.WORKSPACE_NOT_READY -> IndexSyncRejectionWireDocument.WORKSPACE_NOT_READY
        IndexSyncRejection.INVALID_SOURCE_ROOT_SCOPE -> IndexSyncRejectionWireDocument.INVALID_SOURCE_ROOT_SCOPE
        ...
        IndexSyncRejection.PUBLICATION_INVALIDATED -> IndexSyncRejectionWireDocument.PUBLICATION_INVALIDATED
...
private fun IndexSyncRejectionWireDocument.toContract(): IndexSyncRejection =
    when (this) {
        IndexSyncRejectionWireDocument.WORKSPACE_NOT_READY -> IndexSyncRejection.WORKSPACE_NOT_READY
        IndexSyncRejectionWireDocument.INVALID_SOURCE_ROOT_SCOPE -> IndexSyncRejection.INVALID_SOURCE_ROOT_SCOPE
        ...
        IndexSyncRejectionWireDocument.PUBLICATION_INVALIDATED -> IndexSyncRejection.PUBLICATION_INVALIDATED
