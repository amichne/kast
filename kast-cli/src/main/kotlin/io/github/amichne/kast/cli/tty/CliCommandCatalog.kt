...
internal object CliCommandCatalog {
    ...
    private val commands: List<CliCommandMetadata> = listOf(
        ...
        CliCommandMetadata(
            ...
            usages = listOf("$CLI_EXECUTABLE_NAME resolve '{\"workspaceRoot\":\"/ws\",\"symbol\":\"MyClass\"}'"),
            visible = false,
        ),
        CliCommandMetadata(
            ...
            description = "Hidden native wrapper command. Accepts one JSON request argument.",
            usages = listOf("$CLI_EXECUTABLE_NAME references '{\"workspaceRoot\":\"/ws\",\"symbol\":\"myFun\"}'"),
            visible = false,
        ),
        CliCommandMetadata(
            ...
            description = "Hidden native wrapper command. Accepts one JSON request argument.",
            usages = listOf("$CLI_EXECUTABLE_NAME callers '{\"workspaceRoot\":\"/ws\",\"symbol\":\"myFun\"}'"),
            visible = false,
        ),
        CliCommandMetadata(
            ...
            description = "Hidden native wrapper command. Accepts one JSON request argument.",
            usages = listOf("$CLI_EXECUTABLE_NAME diagnostics '{\"workspaceRoot\":\"/ws\",\"filePaths\":[\"/ws/src/Main.kt\"]}'"),
            visible = false,
        ),
        CliCommandMetadata(
            ...
            description = "Hidden native wrapper command. Accepts one JSON request argument.",
            usages = listOf("$CLI_EXECUTABLE_NAME rename '{\"workspaceRoot\":\"/ws\",\"type\":\"RENAME_BY_SYMBOL_REQUEST\",\"symbol\":\"old\",\"newName\":\"new\"}'"),
            visible = false,
        ),
        CliCommandMetadata(
            ...
            description = "Hidden native wrapper command. Accepts one JSON request argument.",
            usages = listOf("$CLI_EXECUTABLE_NAME scaffold '{\"workspaceRoot\":\"/ws\",\"targetFile\":\"/ws/src/Foo.kt\"}'"),
            visible = false,
        ),
        CliCommandMetadata(
            ...
            description = "Hidden native wrapper command. Accepts one JSON request argument.",
            usages = listOf("$CLI_EXECUTABLE_NAME write-and-validate '{\"workspaceRoot\":\"/ws\",\"type\":\"CREATE_FILE_REQUEST\",\"filePath\":\"/ws/src/New.kt\"}'"),
            visible = false,
        ),
        CliCommandMetadata(
