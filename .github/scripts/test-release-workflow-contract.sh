...
require_contains "$runtime_artifact_contract" "kast package ubuntu-debian-bundle" "Runtime artifact docs must document bundle packaging"
require_contains "$runtime_artifact_contract" "kast install activate-bundle" "Runtime artifact docs must document bundle activation"
