...
require_block_contains "$ci_workflow" "  source-bound-headless-backend:" "  install-ubuntu-debian-container:" "Assert source-bound distribution excludes fat jar" "The sole pull-request portable producer must guard the no-fat-jar layout"
