 ...
 *
 * Implementations parse public boundary documents into the supplied strong service contracts and project their closed
 * results back to protocol outcomes. Canonical definitions, serializers, and typed bindings remain owned and
 * constructed by runtime composition.
 */
