...
class SourceReadCliContractTest {
    ...
    fun `source read composes structural filters window bounds and continuation`() {
        ...
        val expected =
            SourceReadRequest(
                ...
                SourceRegionSelectionDocument.Enclosing(SourceEnclosingRegionKindDocument.CALLABLE_BODY),
                ...
                SourceReadPageDocument.Continue(protocolText("source-read-continuation-v1|${"a".repeat(64)}")),
            )
    ...
    private fun CliCommandParsing.sourceRequest(): SourceReadRequest {
        ...
        val admitted =
            when (val envelope = WireRequestEnvelope.admit(semantic.request.document)) {
