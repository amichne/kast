...
enum class ReadLimitParameter(val defaultValue: Int, val unit: ReadLimitUnit, val minimum: Int = 1) {
    ...
    EXECUTION_MAX_MILLIS(DEFAULT_EXECUTION_CEILING, ReadLimitUnit.MILLISECONDS),
    EXECUTION_MAX_WORK(DEFAULT_EXECUTION_CEILING, ReadLimitUnit.COUNT),
    EXECUTION_MAX_RESULTS(DEFAULT_EXECUTION_CEILING, ReadLimitUnit.COUNT),
    EXECUTION_MAX_RETURNED_BYTES(DEFAULT_EXECUTION_CEILING, ReadLimitUnit.BYTES),
    ...
    SOURCE_CONTINUATION_BYTES(DEFAULT_SOURCE_CONTINUATION_BYTES, ReadLimitUnit.BYTES),
    SOURCE_CONTINUATION_TTL_MILLIS(DEFAULT_SOURCE_CONTINUATION_TTL_MILLIS, ReadLimitUnit.MILLISECONDS),
...
private const val DEFAULT_HOST_QUERY_MILLIS = 30_000
private const val DEFAULT_HOST_CONNECTION_MILLIS = 31_000
private const val DEFAULT_CLIENT_EXCHANGE_MILLIS = 32_000
...
private const val DEFAULT_SOURCE_CONTINUATION_BYTES = 32 * 1_024 * 1_024
private const val DEFAULT_SOURCE_CONTINUATION_TTL_MILLIS = 600_000
