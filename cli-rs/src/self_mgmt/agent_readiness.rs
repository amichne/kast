...
fn render_plugin_guidance_region(workspace_root: &Path) -> String {
    ...
    [
        ...
        "Use the plugin only for exact-workspace runtime preparation; `kast setup --source <bundle>` remains the sole release installation path."
            .to_string(),
