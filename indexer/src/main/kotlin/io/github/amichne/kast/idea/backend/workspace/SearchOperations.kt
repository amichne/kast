...
internal suspend fun KastIndexerBackend.fileOutlineOperation(query: ParsedFileOutlineQuery): FileOutlineResult = withContext(readDispatcher) {
...
internal suspend fun KastIndexerBackend.workspaceSymbolSearchOperation(query: ParsedWorkspaceSymbolQuery): WorkspaceSymbolResult = withContext(readDispatcher) {
...
internal suspend fun KastIndexerBackend.workspaceSearchOperation(query: ParsedWorkspaceSearchQuery): WorkspaceSearchResult = withContext(readDispatcher) {
...
internal fun <T : PsiElement> KastIndexerBackend.collectMatchingSymbols(
...
internal fun KastIndexerBackend.isWorkspaceFile(filePath: String): Boolean {
...
internal fun KastIndexerBackend.compileWorkspaceSearchRegex(query: ParsedWorkspaceSearchQuery): Regex? =
        if (query.regex) {
            Regex(
                query.pattern.value,
...
internal fun KastIndexerBackend.searchColumns(
        line: String,
...
internal fun KastIndexerBackend.matchesFileGlob(filePath: String, fileGlob: String): Boolean {
