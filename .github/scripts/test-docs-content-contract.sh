...
require_contains "$install_doc" "does not install Copilot package files" "Install docs must keep v1 setup asset scope minimal"
...
require_contains "$quickstart_doc" "kast setup --workspace-root" "Quickstart must install repository guidance"
