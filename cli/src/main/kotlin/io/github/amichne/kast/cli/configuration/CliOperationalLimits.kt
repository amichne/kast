...
internal object CliOperationalLimits {
    ...
    val declarations: List<ConfigurationOperationalLimit> =
        listOf(
            limit(
                "cli.request.maximum_bytes",
                maximumRequestDocumentBytes.toLong(),
                ConfigurationUnit.BYTES,
                "maximumRequestDocumentBytes",
                ConfigurationScope.REQUEST,
            ),
            limit(
                "cli.launch.wrapper_timeout",
                directLaunchTimeoutSeconds * 1_000,
                ConfigurationUnit.MILLISECONDS,
                "directLaunchTimeoutSeconds",
                ConfigurationScope.WORKSPACE,
            ),
            limit(
                "cli.launchctl.timeout",
                launchctlTimeoutSeconds * 1_000,
                ConfigurationUnit.MILLISECONDS,
                "launchctlTimeoutSeconds",
                ConfigurationScope.WORKSPACE,
            ),
            limit(
                "cli.process_stop.wait_timeout",
                processStopTimeoutSeconds * 1_000,
                ConfigurationUnit.MILLISECONDS,
                "processStopTimeoutSeconds",
                ConfigurationScope.WORKSPACE,
            ),
            limit(
                "cli.seed.project_state.maximum_bytes",
                maximumProjectStateBytes,
                ConfigurationUnit.BYTES,
                "maximumProjectStateBytes",
                ConfigurationScope.WORKSPACE,
            ),
            limit(
                "cli.bootstrap.state.maximum_bytes",
                maximumBootstrapDocumentBytes.toLong(),
                ConfigurationUnit.BYTES,
                "maximumBootstrapDocumentBytes",
                ConfigurationScope.WORKSPACE,
            ),
            limit(
                "cli.startup.progress.maximum_lines",
                maximumProgressLines.toLong(),
                ConfigurationUnit.COUNT,
                "maximumProgressLines",
                ConfigurationScope.WORKSPACE,
            ),
            limit(
                "cli.startup.progress.heartbeat",
                progressHeartbeatMillis,
                ConfigurationUnit.MILLISECONDS,
                "progressHeartbeatMillis",
                ConfigurationScope.WORKSPACE,
            ),
            limit(
                "cli.endpoint.maximum_path_bytes",
                maximumEndpointPathBytes.toLong(),
                ConfigurationUnit.BYTES,
                "maximumEndpointPathBytes",
                ConfigurationScope.WORKSPACE,
            ),
        )
