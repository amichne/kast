...
| --- | --- |
| **Sidecar routes** | Symbol discovery and inspection, source and relation reads, traversal, diagnostics, planning, verified application, and recovery are the nine public installed capabilities. Index synchronization and topology remain internal prerequisites. |
