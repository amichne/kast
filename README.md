...
For CI or headless agent installs from self-contained internal artifacts, use
the [install guide](https://kast.michne.com/getting-started/install/#headless-agent-bundle).
