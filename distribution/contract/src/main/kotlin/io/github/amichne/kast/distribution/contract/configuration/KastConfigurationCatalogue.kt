...
enum class ConfigurationParameter(
    ...
    INSTALL_ASSETS_DIRECTORY("KAST_INSTALL_ASSETS_DIRECTORY", ConfigurationSyntax.ABSOLUTE_PATH, ConfigurationScope.INSTALLATION,
    ...
    INSTALL_CONTROL_ROOT("KAST_INSTALL_CONTROL_ROOT", ConfigurationSyntax.ABSOLUTE_PATH, ConfigurationScope.INSTALLATION, ":cli",
        mutability = ConfigurationMutability.DERIVED),
    INSTALL_CONTROL_ARCHIVE("KAST_INSTALL_CONTROL_ARCHIVE", ConfigurationSyntax.ABSOLUTE_PATH, ConfigurationScope.INSTALLATION, ":cli",
        mutability = ConfigurationMutability.DERIVED),
    INSTALL_CONTROL_SHA256("KAST_INSTALL_CONTROL_SHA256", ConfigurationSyntax.OWNER_INPUT, ConfigurationScope.INSTALLATION, ":cli",
        mutability = ConfigurationMutability.DERIVED),
    INSTALL_RUNTIME_ARCHIVE("KAST_INSTALL_RUNTIME_ARCHIVE", ConfigurationSyntax.ABSOLUTE_PATH, ConfigurationScope.INSTALLATION, ":cli",
        mutability = ConfigurationMutability.DERIVED),
    INSTALL_RUNTIME_SHA256("KAST_INSTALL_RUNTIME_SHA256", ConfigurationSyntax.OWNER_INPUT, ConfigurationScope.INSTALLATION, ":cli",
        mutability = ConfigurationMutability.DERIVED),
    INSTALL_VERSION("KAST_INSTALL_VERSION", ConfigurationSyntax.OWNER_INPUT, ConfigurationScope.INSTALLATION, ":cli",
        mutability = ConfigurationMutability.DERIVED),
    INSTALL_JAVA_HOME("KAST_INSTALL_JAVA_HOME", ConfigurationSyntax.ABSOLUTE_PATH, ConfigurationScope.INSTALLATION, ":cli",
        mutability = ConfigurationMutability.DERIVED),
    INSTALL_REFRESH_APP_SERVER("KAST_INSTALL_REFRESH_APP_SERVER", ConfigurationSyntax.SWITCH, ConfigurationScope.INSTALLATION, ":cli", "0",
        mutability = ConfigurationMutability.DERIVED),
