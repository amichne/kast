...
require_contains "$readme" "./install.sh install --workspace-root" "README must document the root macOS installer"
require_contains "$readme" "./install.sh update --workspace-root" "README must document the explicit update command"
require_contains "$readme" "./install.sh verify --workspace-root" "README must document installer verification"
...
require_contains "$index_doc" "./install.sh install --workspace-root" "Overview must show the macOS installer"
...
require_contains "$install_doc" "./install.sh install --workspace-root" "Install docs must make the root installer primary"
require_contains "$install_doc" "./install.sh update --workspace-root" "Install docs must document the explicit update command"
require_contains "$install_doc" "./install.sh verify --workspace-root" "Install docs must document installer verification"
...
require_contains "$quickstart_doc" "./install.sh install --workspace-root" "Quickstart must install through the root macOS installer"
require_contains "$quickstart_doc" "./install.sh update --workspace-root" "Quickstart must expose the explicit update command"
