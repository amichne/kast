...
- Create extension files only for integration APIs, many unrelated receivers, or a separate package vocabulary.
- Do not use extensions to hide dependencies or side effects.
- Put construction factories in the companion when they define the type's contract.
