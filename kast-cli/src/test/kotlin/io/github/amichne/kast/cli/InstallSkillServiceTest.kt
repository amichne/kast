...
class InstallSkillServiceTest {
    ...
    fun `install copies bundled skill tree and writes version marker`() {
        ...
        assertTrue(Files.isRegularFile(installedSkillDir.resolve("value-proof/catalog.json")))
        assertTrue(Files.isRegularFile(installedSkillDir.resolve("value-proof/bindings/konditional.json")))
        assertTrue(Files.isRegularFile(installedSkillDir.resolve("value-proof/scripts/render_prompts.py")))
