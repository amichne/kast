...
backend proves the relevant provider/index work completed for the anchored
subject and scope.
...
page does not refresh the selector, widen the scope, or upgrade coverage.

The CLI preserves coverage and cardinality evidence in compact output. It may
omit redundant detail but must not synthesize completeness.
