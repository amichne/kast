...
internal fun PublicQueryMatch.canonical(): SymbolDiscoveryMatchDocument =
    when (this) {
        PublicQueryMatch.EXACT -> SymbolDiscoveryMatchDocument.EXACT_NAME
        PublicQueryMatch.FUZZY -> SymbolDiscoveryMatchDocument.FUZZY
    }

internal fun PublicQueryDeclarationKind.canonical(): QueryDeclarationKindDocument =
    when (this) {
...
internal fun PublicQueryContainment.canonical(): QueryContainmentDocument =
    when (this) {
...
internal fun PublicQueryVisibility.canonical(): QueryVisibilityDocument =
    when (this) {
...
internal fun PublicQueryRelation.canonical(): RelationKindDocument =
    when (this) {
...
internal fun PublicQueryField.canonical(): QuerySymbolFieldDocument =
    when (this) {
