...
- Derive physical write-ownership anchors from the canonical batch; ignore a mixed checkpoint only
  when a later canonical batch's physical anchor proves successor ownership of that checkpoint.
