...
internal fun assertQualified(
    ...
    val qualified =
        fixture.query.read(fixture.compiledScope, fixture.request).outcome() as NativeRelationOutcome.Qualified
...
internal fun root(): CanonicalWorkspaceRoot = CanonicalWorkspaceRoot.fromCanonicalPath(Path.of("/workspace")).refined()

internal fun lease(): SemanticReadLease = SemanticReadLease(root(), EvidenceGeneration.parse(21L).refined())
...
internal class StepClock(private val step: Long = 100L) : IntellijRelationNanoClock {
...
): Refinement<Strong, OtherFailure> =
    when (this) {
