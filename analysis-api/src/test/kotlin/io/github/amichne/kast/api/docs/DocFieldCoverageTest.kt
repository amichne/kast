...
class DocFieldCoverageTest {
    ...
    private val registeredSerializers: List<Pair<String, KSerializer<*>>> = listOf(
        ...
        "CurrentCapabilityLaneEvidence" to CurrentCapabilityLaneEvidence.serializer(),
        "RetainedCapabilityLaneEvidence" to RetainedCapabilityLaneEvidence.serializer(),
        "PreviousCapabilityLaneEvidence" to PreviousCapabilityLaneEvidence.serializer(),
        "CurrentCapabilityLaneReadiness" to CurrentCapabilityLaneReadiness.serializer(),
        "CurrentCapabilityLaneReadiness.Available" to CurrentCapabilityLaneReadiness.Available.serializer(),
        "CurrentCapabilityLaneReadiness.Building" to CurrentCapabilityLaneReadiness.Building.serializer(),
        "CurrentCapabilityLaneReadiness.Blocked" to CurrentCapabilityLaneReadiness.Blocked.serializer(),
        "RetainedCapabilityLaneFallback" to RetainedCapabilityLaneFallback.serializer(),
        "RetainedCapabilityLaneFallback.None" to RetainedCapabilityLaneFallback.None.serializer(),
        "RetainedCapabilityLaneFallback.Previous" to RetainedCapabilityLaneFallback.Previous.serializer(),
        "RetainedCapabilityLaneReadiness" to RetainedCapabilityLaneReadiness.serializer(),
        "RetainedCapabilityLaneReadiness.Available" to RetainedCapabilityLaneReadiness.Available.serializer(),
        "RetainedCapabilityLaneReadiness.Building" to RetainedCapabilityLaneReadiness.Building.serializer(),
        "RetainedCapabilityLaneReadiness.Blocked" to RetainedCapabilityLaneReadiness.Blocked.serializer(),
        "RetainedWorkspaceGenerationStatus" to RetainedWorkspaceGenerationStatus.serializer(),
        "RetainedWorkspaceGenerationStatus.None" to RetainedWorkspaceGenerationStatus.None.serializer(),
        "RetainedWorkspaceGenerationStatus.Previous" to RetainedWorkspaceGenerationStatus.Previous.serializer(),
