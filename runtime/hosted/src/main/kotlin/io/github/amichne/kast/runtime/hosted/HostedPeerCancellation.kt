...
internal enum class HostedPeerTermination { DISCONNECTED, EXTRA_INPUT }
...
internal suspend fun SocketChannel.awaitHostedPeerTermination(): HostedPeerTermination = withContext(Dispatchers.IO) {
    ...
    try {
        Selector.open().use { selector ->
            ...
            error("Peer observation loop ended")
        }
    } finally {
