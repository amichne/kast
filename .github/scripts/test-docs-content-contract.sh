...
require_contains "$install_doc" "kast agent setup" "Install docs must make repository agent guidance primary"
require_contains "$install_doc" "kast agent setup --dry-run" "Install docs must document harness-agnostic setup planning"
require_contains "$install_doc" ".agents/skills/kast" "Install docs must document the shared skill target"
require_contains "$install_doc" "--agents-md" "Install docs must document explicit AGENTS.md targets"
require_contains "$install_doc" "BEGIN KAST MANAGED" "Install docs must document fenced AGENTS.md ownership"
...
require_contains "$install_repair_doc" "kast agent setup" "Install command docs must cover harness-agnostic setup"
require_contains "$install_repair_doc" ".agents/skills/kast" "Install command docs must cover the shared skill target"
require_contains "$install_repair_doc" "--agents-md" "Install command docs must cover explicit AGENTS.md targets"
require_contains "$install_repair_doc" "kast agent up --dry-run" "Install command docs must cover setup plus runtime bring-up"
require_contains "$install_repair_doc" "agentsMdTargets" "Install command docs must cover AGENTS.md target dry-run output"
...
require_contains "$agent_doc" "kast agent setup --dry-run" "Agent command docs must cover harness-agnostic setup planning"
require_contains "$agent_doc" ".agents/skills/kast" "Agent command docs must cover the shared skill target"
require_contains "$agent_doc" "--agents-md" "Agent command docs must cover explicit AGENTS.md targets"
