...
@Serializable
internal data class TraversalPartialExpansionCliDocument(
    val subject: String,
    val depth: Int,
...
@Serializable
internal enum class TraversalExpansionScopeCliDocument {
    @SerialName("page") PAGE
}

@Serializable
internal enum class TraversalExpansionRemainderCliDocument {
    @SerialName("continuation_retained") CONTINUATION_RETAINED,
    @SerialName("not_explored") NOT_EXPLORED,
}

internal fun TraversalPartialExpansionDocument.toCliDocument() =
