 ...
 * [normalizePath] for workspace boundary checks on outgoing edges.
 */
internal class CallEdgeResolver(
...
private fun PsiElement.isWithinWorkspaceRoot(workspaceRoot: Path): Boolean {
    ...
    val filePath = runCatching { normalizePath(Path.of(vf.path)) }.getOrNull() ?: return false
