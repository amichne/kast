...
@JvmInline value class SidecarTelemetryDirectoryPath internal constructor(val value: String)

@JvmInline value class SidecarTraceFilePath internal constructor(val value: String)
...
data class SidecarTelemetryOutput
private constructor(
    ...
    companion object {
        /**
         * Proof transition: `String -> Refinement<SidecarTelemetryOutput, SidecarTelemetryOutputFailure>`.
         *
         * Establishes one absolute normalized per-socket destination inside the sidecar's durable state directory.
         * Expected path rejection remains closed data. Raw text leaves only at the CLI/indexer socket boundary and the
         * telemetry filesystem adapter.
         */
        fun fromSocketPath(rawSocketPath: String): Refinement<SidecarTelemetryOutput, SidecarTelemetryOutputFailure> {
            ...
            val fileName =
                socketPath.fileName ?: return Refinement.Rejected(SidecarTelemetryOutputFailure.MISSING_FILE_NAME)
