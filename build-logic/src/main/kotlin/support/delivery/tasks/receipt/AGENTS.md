...
- `gate/registration/ReceiptProgressionRegistration.kt` is the Gradle registration authority for
  KVP-001 through KVP-010 and KVP-012 through KVP-015; the convention script retains only projection,
...
- `gate/` owns KVP-006's positive and negative structural reports over all 129 receipt tasks and its
  ...
  KVP-015's supported-build signal ledger and the complete KVP-014 closure. Structural validation
