...
import io.github.amichne.kast.protocol.wire.presentation.OperationCompletion
...
object ExistingIdeDocuments {
    ...
    private fun refreshResponse(
        ...
        val document =
            CanonicalJsonDocument.generated(
                    io.github.amichne.kast.protocol.contract.WorkspaceRefreshResponse.serializer()
                )
                .create(response)
        return when (response.result) {
            ...
            is io.github.amichne.kast.protocol.contract.WorkspaceRefreshResult.Pending ->
                ExistingIdeExchange.Semantic(
                    io.github.amichne.kast.protocol.wire.presentation.ProjectedOperationOutcome.Qualified(document)
                )
            ...
            is io.github.amichne.kast.protocol.contract.WorkspaceRefreshResult.Rejected ->
                ExistingIdeExchange.Semantic(
                    io.github.amichne.kast.protocol.wire.presentation.ProjectedOperationOutcome.Rejected(document)
                )
        }
    }
...
fun ExistingIdeReadOperation.admitOutcome(
    raw: String,
    root: CanonicalRoot,
    descriptor: ExistingIdeDescriptor,
