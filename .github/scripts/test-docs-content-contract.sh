...
require_contains "$readme" "kast install headless" "README must document explicit headless backend installation"
...
require_contains "$install_doc" "kast install headless" "Install docs must document explicit headless backend installation"
require_contains "$install_doc" "--skip-headless" "Install docs must document setup component skip flags"
...
require_contains "$install_doc" '## Ubuntu/Debian bundle' "Install docs must document the Ubuntu/Debian bundle"
...
require_contains "$install_doc" 'scripts/package-ubuntu-debian-bundle.sh' "Install docs must document the canonical bundle packager"
require_contains "$install_doc" 'kast-ubuntu-debian-headless-x86_64-<version>.tar.gz' "Install docs must name the Ubuntu/Debian bundle asset"
...
require_contains "$quickstart_doc" 'kast setup' "Quickstart must show the setup command"
require_contains "$quickstart_doc" 'kast install headless' "Quickstart must show explicit headless backend installation"
...
require_contains "$agents_doc" "kast install headless" "Agent docs must show explicit headless backend installation"
