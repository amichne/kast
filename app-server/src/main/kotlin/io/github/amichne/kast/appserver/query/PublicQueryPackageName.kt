...
internal value class PublicQueryPackageName private constructor(val value: String) {
    companion object {
        ...
        /**
         * Refines String to a dotted package name or [PublicQueryPackageNameFailure].
         * Raw extraction belongs only to query serialization and canonical protocol lowering.
         */
        fun parse(raw: String): Refinement<PublicQueryPackageName, PublicQueryPackageNameFailure> = when {
...
internal enum class PublicQueryPackageNameFailure { TOO_LONG, INVALID_NAME }
