...
object InstallationOperationalLimits {
    ...
    val declarations: List<ConfigurationOperationalLimit> = listOf(
        limit("installation.retirement.child_timeout", retirementChildTimeoutMillis, ConfigurationUnit.MILLISECONDS, "retirementChildTimeoutMillis", projected = true),
        ...
        limit("installation.download.retries", downloadRetries, ConfigurationUnit.COUNT, "downloadRetries", projected = true),
        limit("installation.download.retry_delay", downloadRetryDelayMillis, ConfigurationUnit.MILLISECONDS, "downloadRetryDelayMillis", projected = true),
        limit("installation.state.maximum_entries", stateMaximumEntries, ConfigurationUnit.COUNT, "stateMaximumEntries", projected = true),
    )
