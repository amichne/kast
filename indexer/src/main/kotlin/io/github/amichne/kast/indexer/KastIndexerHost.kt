...
class KastIndexerHost(private val runtime: KastRuntimeDispatchOperations) {
    /**
     * Proof transition: `String -> KastRuntimeDispatch`.
     *
     * Establishes canonical request admission and exact target operation routing through the sole runtime composition.
     * Expected transport and semantic failures remain closed data. Raw documents may cross only this outer host frame.
     */
