...
- Use the graph-admitted hosted-composition ready frontier as the inclusive batch baseline;
  physical ownership filtering prevents KVP-031 paths from entering KVP-011 evidence.
