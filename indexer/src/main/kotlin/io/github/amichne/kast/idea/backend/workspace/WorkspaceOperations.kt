...
internal suspend fun KastIndexerBackend.completionsOperation(query: ParsedCompletionsQuery): CompletionsResult = withContext(readDispatcher) {
...
internal suspend fun KastIndexerBackend.workspaceFilesOperation(query: ParsedWorkspaceFilesQuery): WorkspaceFilesResult = withContext(readDispatcher) {
        telemetry.inSpan(
...
internal suspend fun KastIndexerBackend.semanticInsertionPointOperation(
