...
class ConfigurationFieldDecoder : NullHandlingDecoder<ConfigurationField<*>> {
    ...
    private companion object {
        val fieldDecodersByType: Map<KClass<*>, FieldDecoder> = mapOf(
            ...
            ProjectOpenAutoExcludeGit::class to FieldDecoder(ValueKind.Boolean) { ProjectOpenAutoExcludeGit(it as Boolean) },
            ProjectOpenProfile::class to FieldDecoder(ValueKind.String) { ProjectOpenProfile(it as String) },
            ProjectOpenProfileAutoInit::class to FieldDecoder(ValueKind.Boolean) { ProjectOpenProfileAutoInit(it as Boolean) },
            ...
            HeadlessBackendEnabled::class to FieldDecoder(ValueKind.Boolean) { HeadlessBackendEnabled(it as Boolean) },
            HeadlessRuntimeLibsDir::class to FieldDecoder(ValueKind.OptionalString) { HeadlessRuntimeLibsDir(it as OptionalConfigString) },
            HeadlessIdeaHome::class to FieldDecoder(ValueKind.OptionalString) { HeadlessIdeaHome(it as OptionalConfigString) },
