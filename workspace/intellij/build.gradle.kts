...
private val extractedIdeaDistributionDirectory =
    objects.directoryProperty().apply {
        set(
            file(
                gradle.gradleUserHomeDir.resolve("kast/workspace-intellij-idea-distributions/$ideaDistributionVersion")
            )
        )
    }

val extractWorkspaceIdeaDistribution by
