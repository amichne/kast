...
class CanonicalSourceReadEntityProjectionTest {
    ...
    fun `declaration entity projects reusable source parent and candidate selectors`() {
        ...
        val projectedEntity =
            SourceSelectorTokenCodec.decode(SourceSelectorToken.parse(declaration.selection.selector.value).refined())
                .refined()
        val projectedParent =
            SourceSelectorTokenCodec.decode(SourceSelectorToken.parse(declaration.parentSelector.value).refined())
                .refined()
    ...
    private fun text(raw: String) = io.github.amichne.kast.protocol.contract.ProtocolText.parse(raw).refined()
