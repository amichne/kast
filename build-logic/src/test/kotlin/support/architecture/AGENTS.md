...
- `IdeReadFirewallTest.kt` constructs bytecode for all fixed KVP-009 forbidden authorities and
  ...
  effects, dependency sets, and `RUNTIME_SPLIT` materialization stage. It also proves the generated
  report codec preserves the closed proof and rejects tampering.
