# KVP-010 and KVP-012 through KVP-017 plugin receipt guide
...
existing-Project admission to `project/`.
...
- Admit KVP-009 and KVP-012 independently for every KVP-014 gate, decode the canonical generated
  ready-Project report, and bind its negative test, positive test, and module build boundary.
...
- Delegate KVP-017 to `project/epoch/`. It directly admits KVP-015, decodes the canonical live
  read-epoch report, and binds the opaque contract, live source, admission, characterization, and
  module task wiring.
