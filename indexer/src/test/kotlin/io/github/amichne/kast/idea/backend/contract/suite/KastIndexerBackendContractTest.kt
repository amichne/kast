...
@TestApplication
internal class KastIndexerBackendContractTest : KastIndexerBackendContractTestFixture() {
    @Test
    ...
    @Test
    fun `compiler implementation publishes only indexer identity`() = runBlocking {
        assertEquals("indexer", backend().capabilities().backendName)
