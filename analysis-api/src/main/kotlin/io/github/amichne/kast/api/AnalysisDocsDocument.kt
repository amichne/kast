 ...
 *
 * Walks the same operation and schema registries as [AnalysisOpenApiDocument],
...
fun main(args: Array<String>) {
    ...
    outputDir.resolve("capabilities.md").toFile().writeText(AnalysisDocsDocument.renderCapabilities())
    outputDir.resolve("api-reference.md").toFile().writeText(AnalysisDocsDocument.renderApiReference())
