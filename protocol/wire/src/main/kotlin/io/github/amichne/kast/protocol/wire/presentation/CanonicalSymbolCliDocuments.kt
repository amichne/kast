...
object CanonicalSymbolCliDocuments {
...
@Serializable
sealed interface SymbolDiscoveryCliDocument {
    @Serializable
    @SerialName("file")
    data class File(
...
private val discoveryCompleteFactory = CanonicalJsonDocument.generated(SymbolDiscoveryCompleteCliDocument.serializer())
private val discoveryQualifiedFactory =
    CanonicalJsonDocument.generated(SymbolDiscoveryQualifiedCliDocument.serializer())
private val descriptionCompleteFactory =
    CanonicalJsonDocument.generated(SymbolDescriptionCompleteCliDocument.serializer())
private val descriptionQualifiedFactory =
    CanonicalJsonDocument.generated(SymbolDescriptionQualifiedCliDocument.serializer())
