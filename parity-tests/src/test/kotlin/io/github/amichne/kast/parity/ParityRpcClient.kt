...
class ParityRpcClient(
    ...
    fun resolveSymbol(query: SymbolQuery): SymbolResult = post("raw/resolve", query)
    fun findReferences(query: ReferencesQuery): ReferencesResult = post("raw/references", query)
    fun callHierarchy(query: CallHierarchyQuery): CallHierarchyResult = post("raw/call-hierarchy", query)
    fun typeHierarchy(query: TypeHierarchyQuery): TypeHierarchyResult = post("raw/type-hierarchy", query)
    fun semanticInsertionPoint(query: SemanticInsertionQuery): SemanticInsertionResult = post("raw/semantic-insertion-point", query)
    fun diagnostics(query: DiagnosticsQuery): DiagnosticsResult = post("raw/diagnostics", query)
    fun rename(query: RenameQuery): RenameResult = post("raw/rename", query)
    fun applyEdits(query: ApplyEditsQuery): ApplyEditsResult = post("raw/apply-edits", query)
    fun optimizeImports(query: ImportOptimizeQuery): ImportOptimizeResult = post("raw/optimize-imports", query)
    fun refresh(query: RefreshQuery): RefreshResult = post("raw/workspace-refresh", query)
