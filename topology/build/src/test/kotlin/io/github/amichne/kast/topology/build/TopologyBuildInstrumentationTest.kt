    ...
    fun `workspace rejection records bounded topology terminal state`() = runTest {
        ...
        val operations =
            TopologyBuildService.create(
                ...
                MovedLeaseGuard,
                { TopologyCandidateEnumeration.Rejected(TopologyCandidateEnumerationFailure.WORKSPACE_UNAVAILABLE) },
                { request ->
        ...
        assertEquals(
            KastSpanObservation(KastSpanCompletion.Rejected(KastSpanFailure.TOPOLOGY_WORKSPACE_NOT_READY)),
...
private data object RejectingSnapshotStore : TopologySnapshotStore {
    ...
    override fun publish(generation: io.github.amichne.kast.topology.contract.CompleteTopologyGeneration) =
