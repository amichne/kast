...
internal fun KastIndexerBackend.semanticGraphSymbol(
...
internal fun KastIndexerBackend.semanticTarget(
    target: PsiElement,
...
internal fun KastIndexerBackend.isOutsideSemanticGraphScope(
    target: PsiElement?,
    sourcePath: SemanticGraphSourcePath,
    semanticScope: Set<SemanticGraphSourcePath>,
): Boolean {
...
internal fun KastIndexerBackend.relativePathOr(
    element: PsiElement,
