...
- `tasks/receipt/` owns typed post-authority progression. KVP-002 through KVP-010 and KVP-012
  through KVP-016 execute their exact included-build gates without shell parsing, emit generated
  ...
  KVP-015 and binds the detached existing-Project model contract.
