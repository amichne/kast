...
internal suspend fun KastIndexerBackend.implementationsOperation(
    ...
    telemetry.inSpan(IdeaTelemetryScope.IMPLEMENTATIONS, "kast.idea.implementations") {
        ...
        val providerBudget = EdgeDiscoveryBudget(
            maxCandidates = KastIndexerBackend.RELATIONSHIP_STATE_CAPACITY,
        )
...
internal suspend fun KastIndexerBackend.implementationRelationsOperation(
