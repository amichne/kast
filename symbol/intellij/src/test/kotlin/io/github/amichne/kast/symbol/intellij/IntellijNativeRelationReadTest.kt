...
class IntellijNativeRelationReadTest {
    ...
    fun `compiled scope cannot diverge from the exact selector scope`() {
        ...
        val divergent =
            CompiledIntellijSearchScope(
                ...
                scope =
                    (fixture.request.selector.scope as SymbolSearchScope.Workspace).copy(
        ...
        val rejected = fixture.query.read(divergent, fixture.request) as IntellijNativeRelationExecution.Rejected
    ...
    fun `dumb transitions provider failure and cancellation remain truthful`() {
        val initialDumb = fixture(environmentState = { IntellijDiscoveryEnvironmentState.DUMB })
        assertEquals(
    ...
    fun `subject identity rejections remain distinct and produce no facts`() {
        val expected =
            mapOf(
                IntellijNativeRelationSearchRejection.STALE_SELECTOR to IntellijNativeRelationRejection.STALE_SELECTOR,
                IntellijNativeRelationSearchRejection.OUTSIDE_SCOPE to IntellijNativeRelationRejection.OUTSIDE_SCOPE,
        ...
        expected.forEach { (native, public) ->
            ...
            assertEquals(
                public,
                (fixture.query.read(fixture.compiledScope, fixture.request) as IntellijNativeRelationExecution.Rejected)
                    .reason,
            )
        }
    }
