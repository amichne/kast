...
the JetBrains-installed Kast plugin enabled. After preparation, acquire an IDEA
lease and pass its ID to verification and every semantic command for the same
absolute path.
