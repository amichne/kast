...
value class IndexerHeapSize private constructor(val mebibytes: Int) {
    companion object {
        ...
        fun parse(raw: String?): Refinement<IndexerHeapSize, IndexerHeapFailure> {
            ...
            val units = raw.dropLast(1).toLongOrNull()
                ?: return Refinement.Rejected(IndexerHeapFailure.OVERFLOW)
...
enum class IndexerHeapFailure { INVALID_SYNTAX, OVERFLOW, BELOW_INITIAL_HEAP }
