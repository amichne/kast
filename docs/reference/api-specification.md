...
`../kast-rs/.agents/skills/kast/references/commands.json` and is packaged by the Rust
CLI in `kast-rs`.
...
This section is generated from `../kast-rs/.agents/skills/kast/references/commands.json`
