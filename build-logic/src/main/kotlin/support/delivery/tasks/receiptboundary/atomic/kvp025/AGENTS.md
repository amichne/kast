...
- Observe every changed path after KVP-024, retain only KVP-025-owned paths, and admit a mixed
  delivery checkpoint only through the graph-derived KVP-025/KVP-026/KVP-027 write union; never
  use a Git pathspec to hide the full observation.
