...
private fun SourceTextMutation.diffFragment(): String =
    when (this) {
        is SourceTextMutation.CreateFile ->
            content.value.removeSuffix("\n").lineSequence().joinToString("\n") { line -> "+$line" }
...
private fun String.protocolPreviewDiff(): ChangePreviewDiff =
    when (val parsed = ChangePreviewDiff.parse(this)) {
