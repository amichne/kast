...
class IntellijSymbolExactCompilerAdapter internal constructor(private val resolver: IntellijSymbolSelectorResolver) {
     ...
     *
     * A resolved compilation establishes current-lease admission, exact scope compilation, K2 symbol resolution, and
     * detached selector issuance. [SymbolExactCompilerRejection] is the closed expected failure. Live project, PSI,
     * VFS, scope, and compiler objects remain inside this call.
     */
    suspend fun resolve(
        project: Project,
        ...
        when (
            ...
            is IntellijSymbolSelectorResolution.Resolved -> SymbolResolutionCompilation.Resolved(resolution.selector)
     ...
     *
     * A described compilation establishes current-lease admission and identical K2 compiler evidence under the
     * selector's retained scope before detached projection. [SymbolExactCompilerRejection] is the closed expected
     * failure. Live project, PSI, VFS, scope, and compiler objects remain inside this call.
     */
...
private fun IntellijSymbolSelectorRejection.toCompilerRejection(): SymbolExactCompilerRejection =
    when (this) {
        ...
        IntellijSymbolSelectorRejection.INTERNAL_INVARIANT -> SymbolExactCompilerRejection.INTERNAL_INVARIANT
    }
