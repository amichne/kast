...
class ConfigurationFieldLayoutTest {
    ...
    private companion object {
        val expectedFieldFiles = setOf(
            ...
            "CliBinaryPath.kt",
            "CodexHooksEnabled.kt",
            "CodexPostToolUseEnabled.kt",
            "CodexSessionStartEnabled.kt",
            "CodexAutoStartIndexer.kt",
            "ConfigurationDefault.kt",
            "ConfigurationDefaults.kt",
            "ConfigurationField.kt",
            "IndexerAutoStartConsent.kt",
            "GradleToolingApiTimeoutMillis.kt",
            "GraphIndexingBatchSize.kt",
            "IndexingCriticalPaths.kt",
            ...
            "RelationshipIndexingBatchSize.kt",
            "RelationshipIndexingEnabled.kt",
            "RelationshipIndexingModulePriorityDepth.kt",
            "RelationshipIndexingParallelism.kt",
