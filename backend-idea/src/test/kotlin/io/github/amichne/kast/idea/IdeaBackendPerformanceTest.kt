 ...
 * requiring a running IDEA or Android Studio instance. The second section exercises actual backend
 * operations through IDEA platform fixtures.
 */
@Tag("performance")
...
/**
 * Performance baselines that exercise actual backend operations through IDEA
 * platform fixtures.
 *
