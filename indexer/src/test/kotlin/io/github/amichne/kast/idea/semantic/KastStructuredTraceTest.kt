...
class KastStructuredTraceTest {
    ...
    fun `trace json includes cross-cutting workspace and invocation fields`() {
        ...
        assertTrue(json.contains("\"canonicalWorkspaceId\":"), json)
        assertTrue(json.contains("\"workspaceDataDirectory\":"), json)
        assertTrue(json.contains("\"workspaceCacheDirectory\":"), json)
        assertTrue(json.contains("\"sourceIndexDatabasePath\":"), json)
        assertTrue(json.contains("\"defaultSocketPath\":"), json)
        ...
        assertTrue(json.contains("\"moduleName\":\"indexer\""), json)
        assertTrue(json.contains("\"gradleProjectPath\":\":indexer\""), json)
