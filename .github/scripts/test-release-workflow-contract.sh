...
require_contains "$release_workflow" ":kast-cli:nativeCompile :kast-cli:portableDistZip" "Release must compile the native CLI before packaging the release asset"
