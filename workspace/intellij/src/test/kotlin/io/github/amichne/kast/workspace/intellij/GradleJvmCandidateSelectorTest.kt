...
class GradleJvmCandidateSelectorTest {
        ...
        val selected =
            assertInstanceOf(
                ...
                GradleJvmCandidateSelector.select(
                    ...
                    listOf(
                        installed(21).copy(source = GradleJvmSelectionSource.AMBIENT_JAVA_HOME),
                        installed(17).copy(source = GradleJvmSelectionSource.REPOSITORY_GRADLE_PROPERTY),
                    ),
                ),
            )
        ...
        val rejected =
            assertInstanceOf(
                ...
                GradleJvmCandidateSelector.select(
                    ...
                    listOf(
                        installed(17),
                        installed(25).copy(source = GradleJvmSelectionSource.REPOSITORY_GRADLE_PROPERTY),
                    ),
                ),
            )
    ...
    private fun sidecar(feature: Int): GradleJvmCandidate =
        GradleJvmCandidate(
    ...
    private fun installed(feature: Int): GradleJvmCandidate =
        GradleJvmCandidate(
