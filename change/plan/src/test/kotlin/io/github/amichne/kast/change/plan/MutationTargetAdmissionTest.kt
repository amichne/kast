...
class MutationTargetAdmissionTest {
    ...
    private fun contentHash(): WorkspaceSourceContentHash = WorkspaceSourceContentHash.parse("a".repeat(64)).refined()
