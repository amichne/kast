 ...
 * Requires real filesystem: in-memory filesystems bypass AnalysisSession workspace refresh semantics.
 */
class AnalysisBackendApplyEditsFileOpsTest {
    @TempDir
    ...
    private suspend fun withBackend(
        block: suspend (AnalysisBackend, AnalysisSession) -> Unit,
    ) {
