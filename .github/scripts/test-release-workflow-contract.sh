...
require_contains "$devin_runtime_workflow" "devin-runtime package" "Devin runtime workflow must package through the Rust CLI"
require_contains "$devin_runtime_workflow" "devin-runtime setup" "Devin runtime workflow must set up through the Rust CLI"
require_contains "$devin_runtime_workflow" "devin-runtime verify" "Devin runtime workflow must verify through the Rust CLI"
require_contains "$ci_workflow" "devin-runtime package" "CI must package the Devin runtime through the Rust CLI"
require_contains "$ci_workflow" "devin-runtime setup" "CI must set up the Devin runtime through the Rust CLI"
require_contains "$ci_workflow" "devin-runtime verify" "CI must verify the Devin runtime through the Rust CLI"
