...
const KAST_TOOLING_CONTEXT = [
  ...
  "If Kast reports a missing backend, missing source index, INDEX_UNAVAILABLE, METRICS_DB_UNAVAILABLE, or NO_BACKEND_AVAILABLE, warm the IDEA backend with `kast setup --workspace-root \"$PWD\" --backend idea` before falling back.",
