# ADR 0011: Repo-native semantic story demo
...
`--output human|toon|json` boundary. The snapshot states which evidence lanes
...
| Public documentation | `docs/getting-started/quickstart.md`, `docs/commands/index.md` |
