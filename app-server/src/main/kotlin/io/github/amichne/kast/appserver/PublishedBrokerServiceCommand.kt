...
object PublishedBrokerServiceCommand {
    ...
    private fun readEnvironment(observed: BrokerServiceLaunchCommand): Map<String, String>? =
        try {
            ...
            val dictionary =
                document.documentElement.directElements().singleOrNull { it.tagName == "dict" } ?: return null
            ...
            if (values["Label"]?.takeIf { it.tagName == "string" }?.textContent != observed.serviceLabel.value)
                return null
            val arguments =
