...
require_contains "$readme" "kast backend install standalone" "README must document on-demand standalone backend installation"
...
require_contains "$install_doc" "kast backend install standalone" "Install docs must document standalone backend installation"
...
require_contains "$install_doc" 'kast-ubuntu-debian-x86_64-<version>.tar.gz' "Install docs must name the Ubuntu/Debian bundle asset"
...
require_contains "$agents_doc" "kast backend install standalone" "Agent docs must show on-demand backend installation"
