...
- [Historical workspace publication](workspace-publication.md) — dirty state to verified ready generation.
...
- [Existing-IDE semantic query](hosted-query.md) — the default seven canonical reads, bounded native CLI/provider acceptance, and the separate earlier class/supertype history.
